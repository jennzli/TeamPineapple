...
public class GoogleSignInServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("sucessfully called google servlet");
		String loggedinuser = request.getParameter("loggedinuser");
		System.out.println("sucessfully called get parameter grom google servlet" + loggedinuser );

		RequestDispatcher rd =  request.getRequestDispatcher("googledashboard.jsp"); 
		//request.setAttribute("SEARCH_RESULT",searchInput);
		session.setAttribute("GMAIL_USERID", "logged_in_gmailid");
